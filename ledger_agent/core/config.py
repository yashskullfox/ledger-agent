"""
ledger_agent.core.config  –  Canonical configuration for ledger_agent
─────────────────────────────────────────────────────────────────────
...
This is the canonical home for runtime configuration. The top-level
`config.py` at the repo root is a thin compatibility shim that re-exports
the symbols defined here (see that file for migration context).
...
# ── Root paths ────────────────────────────────────────────────────────────────
# ROOT_DIR resolves to the repository root (two levels up from this file:
# <repo>/ledger_agent/core/config.py → <repo>/).
...
# Keys mirror the pseudonymised PARSER_ID values declared in each
# ledger_agent/core/parsers/*.py module.
KNOWN_PARSERS = {
    "bank_x_checking": "BANK_X Simple Business Checking",
    "bank_x2_checking": "BANK_X2 Business Checking",
    "bank_x3_checking": "BANK_X3 Business Checking",
    "bank_x4_checking": "BANK_X4 Business Checking",
    "bank_x4_creditcard": "BANK_X4 Business Credit Card",
    "broker_y_brokerage": "BROKER_Y Brokerage / Investment Account",
    "broker_z": "BROKER_Z Activity Statement",
}
